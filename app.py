...
# Spotify 설정 (Render 배포 후 너 도메인으로 바꿀 거임)
sp = spotipy.Spotify(auth_manager=SpotifyOAuth(
    client_id="c2442928740348a1839090999b8b4994",
    client_secret="0627291231d046338dcebf8a78e233ad",
    redirect_uri="https://parrot-song.onrender.com/callback",  # 배포 후 자동 적용
...
def analyze():
    ...
    queries = {
        ...
        '분노': 'angry rock metal', '슬픔': 'sad emotional ballad',
        '중립': 'chill lo-fi calm', '행복': 'happy dance pop summer',
        '혐오': 'intense aggressive hiphop'
    }
    try:
...
@app.route("/callback")
def callback():
    return "Spotify 로그인 완료! 창을 닫고 사이트로 돌아가세요 :)"
